...
assert.match(home, /<animateTransform attributeName="patternTransform" type="translate" values="-10 -2;10 3;-10 -2" dur="48s" repeatCount="indefinite"\/>/);
assert.match(home, /<circle cx="5" cy="5" r="1\.15" fill="url\(#ambient-stroke\)" opacity="\.48"\/>/);
assert.match(home, /<rect class="dot-matrix" x="-180" y="-100" width="1800" height="1180" fill="url\(#ambient-dot-grid\)" opacity="\.34"\/>/);
