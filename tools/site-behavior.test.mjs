...
assert.match(home, /<circle cx="4" cy="4" r="1\.7" fill="url\(#ambient-stroke\)" opacity="\.72"\/>/);
assert.match(home, /<rect class="dot-matrix" x="-180" y="-100" width="1800" height="1180" fill="url\(#ambient-dot-grid\)" opacity="\.58"\/>/);
...
assert.equal((ambientBg.match(/<rect /g) || []).length, 1, 'ambient background should only use one full-screen dot matrix rect');
