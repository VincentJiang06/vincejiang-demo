...
assert.match(home, /<animateTransform attributeName="patternTransform" type="translate" values="-8 -4;8 6;-8 -4" dur="54s" repeatCount="indefinite"\/>/);
...
assert.match(home, /<animateTransform attributeName="transform" type="translate" values="-22 -10;22 10;-22 -10" dur="56s" repeatCount="indefinite"\/>/);
