...
<p>Koretz 反复展示的那条曲线因此被称为锯齿：一套新考试上线，分数先跌回真实水平，随后逐年陡升；换下一套考试，再跌，再陡升。上升段测出的不是学力在增长，而是师生对这套特定题型的熟悉度在增长；每个下降沿都是一次天然审计，暴露出上一段爬升里通胀的部分。因此审计通道是这个领域的关键仪器：NAEP 这类无人为其应试的低利害考试，能把真实增益与通胀分开。机制标注：规则套利（针对题型的应试特化），不是造假；它完全合法，也正因此比作弊普遍得多。</p>` },
    ...
    { t: "h", text: "教到及格线为止" },
    { t: "prose", html: `
<p>问责制的计分方式决定了扭曲的形状。NCLB（美国 2002 年起的联邦教育问责法）以「达标人数」为核心口径，于是教师的理性反应是把资源投向刚好卡在及格线附近的学生（bubble kids）：Neal & Schanzenbach 2010 用芝加哥数据显示，中段学生的分数被抬高，最弱与最强的学生同时被忽视。只计「过线人数」，离线远的学生对指标毫无贡献，被放弃是算出来的，不是狠心。评分环节同样有反应性：纽约州 Regents 考试由本校教师评分，分数分布在及格线上方异常堆积，Dee 等人 2019 年估计约 40% 本应略低于及格线的成绩被人为抬到线上，也就是将近一半的险些不及格被评分者的笔救了回来。作弊的总量也有算法估计：Jacob & Levitt 2003 用异常分数跳变加可疑答案串的模式检测，估计芝加哥每年至少 4% 到 5% 的班级存在教师或管理者改卷，且比例随问责压力上升。三项证据合成一幅分布图：合法的应试特化是主体，评分宽纵是中间带，彻底造假是尾部；压力越大，尾部越厚。</p>` },
