export default {
  ...
  blocks: [
    { t: "prose", html: `
<p>一个听起来像悖论的真实故事：一条数学公式，先把整个市场改造成了它自己描述的样子，又在十四年后亲手毁掉了这个成果。主角是金融学里最有名的期权定价公式 Black–Scholes。社会学家用这个案例造了一个词，叫<strong>操演性（performativity）</strong>：理论不是照相机，拍下世界本来的样子；理论是发动机，把世界拉向它描述的样子。</p>
<p>这个词是法国社会学家 Michel Callon 在 1998 年提出的，他的原话是：经济学不是在观察经济如何运行，而是在「执行、塑造、格式化」经济。他的完整主张更激进：经济不是嵌进社会里的，是嵌进经济学里的。市场要运转，先得有一群会计算的买家卖家，还要有能把一笔交易从千丝万缕的人情关联里切割出来的规则和工具。而这些工具和规则，正是经济学供应的。教科书里那个只认利益的「经济人」就是一例：在 Callon 看来，它不是对人性的错误假设，而是一份逐渐被装置实现的产品说明书。</p>
<p>苏格兰社会学家 Donald MacKenzie 接着做了最关键的一步：把「理论塑造现实」按力度分成四档，从「只是被人使用」到「把世界拉向自己」再到「把自己弄假」，避免它变成一句什么都能解释的万能口号。你在 <code>R06</code> 见过「分类会改变被分类的人」，这里是它的理论版：理论会改变被理论描述的世界。</p>` },
...
<p>接下来是整个案例的核心。交易员开始随身携带 Black 印制的定价活页表，照着公式报价。更重要的是套利：只要市场价偏离公式价，就有人低买高卖赚差价，而套利本身会把市场价往公式价推。于是市场价格逐渐向模型收敛。MacKenzie 与 Millo 2003 年翻检交易所历史档案的研究（发表在《美国社会学杂志》，被引超过 2300）给出了完整弧线：1973 到 1987 年间，模型和市场的拟合越来越好。好到什么程度，有一个技术读数可以说明：模型假设波动率是常数，这意味着不管期权的执行价怎么选，反推出来的隐含波动率都该趋于一致，画出来是一条平线。1987 年之前，市场数据确实如此——从不同执行价反推出的隐含波动率几乎排成一条平线，危机前夕，10% 价外看跌期权与其余期权的隐含波动率差只有约 1.83 个百分点。市场几乎就是模型说的那个世界。注意这句话的方向：不是模型准确描述了市场，而是市场被模型改造得越来越像模型。这就是四档里最强的一档，Barnesian（得名自社会学家 Barry Barnes）。</p>
...
<p>批评者给这套理论画了三条边界。第一条来自哲学家 Mäki 2013 年：「操演」这个词借自语言哲学家 Austin 的「施为句」，说即做，比如「我宣布你们结为夫妻」；但市场向模型收敛不是语言魔法，是套利、装置、利益推动的因果过程，借词要小心。第二条来自 Brisset：不是任何理论都能操演成功，现实会抵抗，理论要自我实现，得有制度、利益和物质装置配合。第三条最尖锐，来自 Mirowski 与 Nik-Khah：研究「经济学家造市场」的人，不能把它当成中性现象，还得问造的是哪一种经济学的市场、为了谁的利益。Marti 与 Gond 2018 年把这些收拢成三个可检验的条件：理论要被当作行动脚本、有配套装置、且没有强反制力量，三者齐备，自我实现才会发生。</p>
<p>把它和红色主线接上。排名反应性（<code>R01</code>）研究「人被测量后如何反应」，操演性研究「理论如何造世界」：前者的输入是一个评价性的数字，盯住被测者的挣扎与问责；后者的输入是一整套理论和装置，盯住世界被塑形。Espeland 与 Sauder 2007 年明知 Callon 的概念在先，仍另选了 reactivity 这个词，理由正是要把测量的效度与问责留在问题中心。两个词不是同义词，是同一台机器的两个观察孔。</p>` },
...
<p><strong>操演不靠信念魔法，靠装置。</strong>交易员不是抽象地「相信」公式，而是每天拿着定价活页表照它报价、按它对冲。这套操作把理论固化成表格、计算器和结算流程，理论正是由此获得了拉动价格的因果力。这也解释了反转那一档为什么可能：装置只执行公式，不检查公式的前提。1987 年组合保险照公式卖出时，公式假设的「交易连续、价格不跳空」正在被它自己制造的踩踏踩碎。</p>` },
