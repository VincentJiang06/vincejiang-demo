export default {
  ...
  blocks: [
    { t: "prose", html: `
<p>为什么排名甩不掉？组织学有个著名的老预言，叫脱耦（decoupling）：组织最擅长阳奉阴违，对外摆出合规的姿态，内部照常运转；Meyer 与 Rowan 1977 年、DiMaggio 与 Powell 1983 年的经典论文都说，为求正当性，组织做象征性顺从即可，产出难以观察的教育组织更是此中老手。照这个预言，排名来袭时法学院本该轻松把它当摆设，何况排名具备一切「该被敷衍」的特征：新来的、外部强加的、昂贵难管的、被内部精英公开鄙视的。可你在 <code>R01</code> 已经见过实况：砍助学金、追失联毕业生、两本账，没有一所学校把它当摆设。脱耦能得逞，前提是内部真实做法不被外界看见——外部只收得到「合规」的姿态。社会学的答案正是从这个前提下手：排名是一种规训权力，靠的不是强制，而是让你持续可见；可见，脱耦赖以存身的「看不见」也就没了。判断一把尺子躲不躲得开，就看这几个开关。</p>
...
<p><strong>流行说法：「规训就是老大哥监控。」</strong>复核结论：规训是生产性的，它生产技能、主体性、自我扫描的习惯；而且它弥散、平庸，经由最日常的程序运作，不需要一个中央监视者。另外，Sauder 与 Espeland 不只是应用 Foucault，还批评了他忽视组织维度：规训如何在组织之间被分工、协调、评估。他们对自家阵营——当代制度理论——也有话说：这套理论把制度当宏观象征系统，丢掉了早期的微观取向，需要 Hallett 与 Ventresca 所谓「被居住的制度」视角把人请回来。</p>` },
