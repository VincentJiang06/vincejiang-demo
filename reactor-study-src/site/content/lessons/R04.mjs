export default {
  ...
  blocks: [
    { t: "prose", html: `
<p>新制度主义有一个著名预言：组织会把「给外界看的仪式性合规」与「实际运作」脱耦（decouple），学校尤其擅长。Meyer 与 Rowan 1977 年、DiMaggio 与 Powell 1983 年的经典论文都指向同一处：为求正当性，组织做象征性顺从即可，产出难以观察的教育组织更是松耦合的老手。照这个预言，排名来袭时法学院本该轻松缓冲掉它，何况排名具备一切「该被去耦」的特征：新近、外部强加、昂贵难管、被内部精英公开鄙视。Sauder 与 Espeland 2009 年发现的恰恰相反：出现了紧耦合。Yale 院长斥排名为 "idiot poll"，Harvard 院长称其 "Mickey Mouse"，鄙视之余仍然紧盯名次。于是他们把提问倒了过来：不问组织为何能去耦，而问为什么某些环境压力比其他压力更「去耦不掉」。</p>
<p>缓冲失败的原因，他们借 Foucault 来解释：排名是一种规训权力（disciplinary power），原文引 "discipline is an art of rank"，纪律本身就是一种排名的艺术。它不靠强制，靠让组织持续可见来运作：毛细血管式、连续、弥散，经由最平庸的日常程序。</p>` },
    ...
    { t: "prose", html: `
<p>关键在排名的四个性质：可通约、相对、广泛流通、零和。零和是决定性的一环：一所学校上升，必然有另一所下降，因此你不可能只做象征性合规，别人不合规你就掉。由此得到一条经验规律：公开的、零和的、可通约化的测量，几乎无法被组织缓冲掉。监视的三个特征在访谈里都有肉身：一位院长把发榜比作「开灯前先闭眼给蟑螂时间逃走」；另一位承认「做决定时我总盯着排名，而不是盯着对学校最好的事」。远距监视一条还借了 Scott 的概念，排名让申请人、校董、州议员这些分散的外行都能「看进」法学院内部，实现远距治理；可读性这个前置条件本身有一整课，见 <code>R05</code>。</p>
<p>规范化的五个过程值得按顺序走一遍，因为它是一条流水线：先把所有法学院设为同类（comparison），再精确区分（differentiation），再排成唯一等级（hierarchization）；等级造出一所抽象的「最优法学院」，各校向它靠拢，招生只认 LSAT 与 GPA，学生构成同质化、种族多样性受损（homogenization）；偏离模板者被排斥与污名，低排名学校即便完全符合 ABA 认证仍被判「不合格」，学生在论坛上自嘲是 "third-tier toilet" 出身（exclusion）。规训还留下了制度化石：Chun 与 Sauder 2023 年记录了「造数专长」（ranking expertise）如何长成一门新职业，学校设专岗管理报给排名的数据，组织内部的依赖关系随之重构。一种外部测量，最终以人事编制的形式住进了被测者体内。</p>
<p>内化的三种情感通道里，焦虑最结构化：排名相对、不稳、高度可见，而院长对名次「责任大于控制力」，这在 Marmot 的健康社会学里恰好是最伤人的处境；受访者说，即便名次升了，「你也只高兴 15 分钟」，然后开始担心明年。抵抗的悖论有先例可援：Burawoy 笔下车间工人的「making out」游戏、Covaleski 等对大会计师事务所的研究都显示，针对控制系统的博弈让人对系统投入更深。法学院的版本是 AALS 委托学者批判排名方法学、给 LSAT 考生寄联署谴责信，结果每一次公开交锋都把排名进一步变成「信念围绕它组织起来的参照点」。gaming 也一样，作者把它重释为一种看似去耦、实则加深内化的抵抗：它挑战排名作为准确表征的正当性，却因为投入更多而使排名更加自然化。原文的收束句值得整句记下：排名同时诱惑与胁迫（seduce and coerce），而这一切以平淡的数字语言进行，反而更有力。</p>
<p>规训力有一个关键的调节变量：垄断。Sauder 与 Espeland 2006 年比较过法学院与商学院，前者面对 USN 近乎垄断且全覆盖的排名，后者面对至少五家方法各异、结果不一致的榜单，学校可以挑对自己有利的那家讲故事，裁量权与松耦合空间随之恢复。排名越多，任一排名的规训力越弱。但他们同时指出一个悖论：用「造更多排名」对冲垄断，会进一步把排名确立为高等教育里正当的问责形式，抵抗手段巩固了被抵抗之物。这条线索通向 <code>R13</code> 的退出政治与 <code>G06</code> 的制度层防御。阵营内部的最新反省也落在同一点上：Chun 2025 年指出，早期研究（包括 Sauder 自己把 USN 当「闯入者」分析的 2008 年论文）过度聚焦单一支配性排名，而现实里的测量多元并存、彼此冲突、持续被争夺，规训模型需要为这种多元性重写。</p>
<p>2022 年起的退榜潮给这条规律提供了极干净的现场证据。Yale、Harvard 领头的头部法学院集体拒绝提交数据，U.S. News 改用公开数据继续排名并大改方法学，随后名次剧烈震荡（细节见 <code>R01</code>）。抵抗没有终结排名，只是换来了一把改了刻度的尺子。这与 2009 年论文「抵抗是权力的构成部分」的论断严丝合缝。不过要给反方留位置：Englund 与 Gerdin 2020 年提出 reactive conformance 的对立面，记录了学者在特定条件下（评价周期长、同侪支持强、替代声誉来源多）确实能暂时抑制顺从压力；Slager 与 Gond 2022 年在 ESG 评级场域观察到企业对评级同时接受与抵抗的矛盾态度（ambivalence），反应性是政治性的、有裁量空间的过程，不是机械传动。内化很难避免，但「不可避免」说得太满。</p>` },
