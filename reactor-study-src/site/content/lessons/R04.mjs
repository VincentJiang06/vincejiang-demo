export default {
  ...
  blocks: [
    { t: "prose", html: `
<p>这课解一个悬案：为什么排名甩不掉。组织学有个著名的老预言，叫脱耦（decoupling）：组织最擅长阳奉阴违，对外摆出合规的姿态，内部照常运转；Meyer 与 Rowan 1977 年、DiMaggio 与 Powell 1983 年的经典论文都说，为求正当性，组织做象征性顺从即可，产出难以观察的教育组织更是此中老手。照这个预言，排名来袭时法学院本该轻松把它当摆设，何况排名具备一切「该被敷衍」的特征：新来的、外部强加的、昂贵难管的、被内部精英公开鄙视的。可你在 <code>R01</code> 已经见过实况：砍助学金、追失联毕业生、两本账，没有一所学校把它当摆设。这课给出社会学的答案：排名是一种规训权力，它不靠强制，靠让你持续可见来运作。弄懂它，你就知道判断一把尺子躲不躲得开，该看哪几个开关。</p>
<p>先看悖论有多刺眼。Sauder 与 Espeland 2009 年发现的不是缓冲成功，而是恰恰相反的紧耦合：Yale 院长斥排名为 "idiot poll"（白痴测验），Harvard 院长称其 "Mickey Mouse"（不入流），鄙视之余仍然紧盯名次。于是他们把提问倒了过来：不问组织为何能去耦，而问为什么某些环境压力比其他压力更「去耦不掉」。他们借来的解释工具，来自法国哲学家 Foucault：排名是一种规训权力（disciplinary power），原文引 "discipline is an art of rank"，纪律本身就是一种排名的艺术。它不靠鞭子，靠让对象持续可见：毛细血管式、连续、弥散，经由最平庸的日常程序运作。</p>` },
