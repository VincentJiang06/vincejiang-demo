export default {
  ...
  blocks: [
    { t: "prose", html: `
<p>这一课讲整门课程被引用最多的一句话。你几乎肯定在哪里见过它：</p>
...
<p>接下来做两件事。第一件，讲清这句话背后的机制：一个好端端的指标，为什么一被拿去当考核目标就失灵。这是整门课的地基，后面几十课都是它的变奏。第二件，讲一桩公案：这句流传最广的话，不是 Goodhart 本人说的，它的真实出处要经过一场三个人的接力。一条研究「指标如何变质」的定律，自己的名言就在流传中变了质，这个故事本身就值十分钟。</p>` },
