...
<p>这句话背后是一个机制：好端端的指标，为什么一被拿去当考核目标就失灵。这是整个家族的地基。它还牵出一桩公案：这句流传最广的话，其实不是 Goodhart 本人说的；真实出处要经过三个人接力才拼得出来。于是就有了这个反讽：一条研究指标如何变质的定律，自己的名言也在流传中变了质。</p>` },
...
<p>然后怪事开始了。1971 年 9 月，英格兰银行放松信贷管制，这个数字和经济之间原本稳定的关系随即松动，1972 至 73 年广义货币增速一度超过 25%，完全脱缰。1973 年底央行掉头搞硬管制，出台一个绰号「胸衣」的制度直接压银行的负债规模。银行立刻发明出不计入管制口径的替代性负债，绕开这套管制；这种操作在行话里叫脱媒，久而久之，绕开监管从应急手段变成了行业手艺。最难看的一幕在撒切尔政府：1980 年的中期财政战略把 £M3 年增速目标定在 7% 到 11%，实际冲到 18% 到 19%，接近翻倍。如果这把尺子还牵着真实经济，货币这么失控，经济本该跟着过热、通胀本该跟着走高；可现实是同一时间经济深度衰退，通胀反而在下降。这组数字说明什么：政府盯住的那个数字，和它想管的真实经济已经彻底脱钩，数字失控与经济降温同时发生，尺子和世界各走各路。财政部的大臣们后来自己引用「Goodhart 定律」解释超标，广义货币目标制在 1985 至 86 年被实质放弃。</p>
...
<p>这条刻度同时标出了定律的边界：它不是「测量无用论」，而是「代理指标加高压优化」这个组合的失效定律。把高压拿掉、把代理链缩短、留一条独立的审计通道，测量依然是已知最强的管理技术。Campbell 本人「实验社会」的立场，说的正是这个。指标什么时候是良性的，<code>B14</code> 专门陈列反方证据与成立条件。</p>` },
