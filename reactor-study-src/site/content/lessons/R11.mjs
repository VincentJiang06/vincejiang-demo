export default {
  ...
  blocks: [
    { t: "prose", html: `
<p>管理学课堂讲了七十年的一个故事：1920 年代，芝加哥郊外的霍桑工厂里，研究者调亮车间的灯，工人产量上升；调暗，产量还是上升；什么都不动，居然也上升。结论：起作用的不是灯，是「有人在关注我」这件事本身。这就是<strong>霍桑效应</strong>，大概是「被观察就会改变行为」最有名的证据。这一课讲它的下半场，知道的人少得多：原始数据被重新翻出来检查之后，故事塌了。这不是猎奇，是本课程给自己立的规矩：整门课都在讲「测量会改变被测者」，那么这个命题最有名的招牌案例，也要经得起同样的检查。</p>
<p>先摆史实。1924 到 1932 年，西方电气公司位于伊利诺伊州西塞罗的霍桑工厂进行了一系列研究：照明实验（1924 年起，与美国国家研究委员会合作）考察灯光亮度与产量的关系；继电器装配试验室（1927 到 1932 年）把五名女工放进单独房间，逐一改变工时、休息和计酬方式。权威报告是 Roethlisberger 与 Dickson 1939 年的《Management and the Worker》，哈佛的 Elton Mayo 据此建立理论，「人际关系学派」的整套管理教义就立在这个故事上。顺带一个冷知识：「霍桑效应」这个名字不是当年研究者起的，是 French 1953 年才铸造、Landsberger 1958 年重新分析时推广的，把它回溯安到 Mayo 头上属于时代错置。被推翻的只是这个案例，反应性本身不受影响，但溯源它有两重收益：学会核查经典，以及看清反应性真正的尺度在制度，不在心理。</p>` },
...
<p>循证医学给了程序性的判决。这个领域做事的方式是系统综述：把一个问题的全部研究收齐、按证据质量分级再下结论。McCambridge、Witton 与 Elbourne 2014 年综述了 19 项研究，结论是「霍桑效应」这个概念太笼统、机制不清，建议改用更精确的「研究参与效应」；这篇被引约 3800 次的论文，实质上是主张把这个名字废掉。此后的检验一边倒：2007 年 McCarney 等少见的随机对照试验，证据有限；2019 年一项专门想把霍桑效应诱发出来的随机试验，什么也没测到；2022 年初级保健领域的元分析倾向保留这个民间名称，但把机制改名为「参与者反应性」。还有个耐人寻味的细节：2017 年有学者建议医学教育研究干脆改用 reactivity 一词，与本课程整条红色分支的用词不谋而合。趋势清楚：设计越严格，强效应越难复现。</p>
<p>「被观察改变行为」其实是一个效应家族，机制各异，证据参差，统称「霍桑」会把好证据和坏证据搅在一起。点几个名。John Henry 效应（1972 年命名，得名自民歌里与蒸汽钻比赛、活活累死的钢钎工）说的是对照组：他们知道自己在被比较，于是格外卖力。demand characteristics（Orne 1962）说的是被试会揣摩实验者想要什么，然后配合演出。还有新奇效应、教师期望的 Pygmalion 效应、安慰剂效应。引用其中任何一个，都应该单独查它自己的证据，而不是拿「霍桑」这个伞形词打包背书。</p>
<p>最后说这个案例对整门课的意义，它解释了红色分支为什么长成这个样子。正因为「被观察的心理战栗」如此难以稳健复现，Espeland 与 Sauder 才把反应性从实验室里的污染项，重铸为制度层面可观察的宏观过程：他们研究的不是女工的心跳，而是排名如何重组整个法学教育场域（那一课在 <code>R01</code>）。把霍桑神话与法学院排名并置，恰好照出两种反应性的差别：一边是微弱、难复现的个体反应，一边是稳健、持续的制度反应，驱动后者的不是「被看」的感觉，而是可通约、公开、零和的度量施加的结构性激励。</p>` },
...
<p><strong>一个站不住的效应流传七十年，因为它是个好故事。</strong>「无论怎么调灯，产量都升」，句式干净、反直觉、一句话就能转述，引用它的人几乎不需要回到原始数据。Chiesa 与 Hobbs 2008 年的论文正面处理了这个现象：好故事如何盖过薄弱证据。由此得到一条一般判据：一个效应的传播力和它的证据强度，是两个独立变量，传播筛选的是故事性，不是稳健性。本课程里每一张纠讹卡，测的都是这两个变量之间的差。</p>` },
