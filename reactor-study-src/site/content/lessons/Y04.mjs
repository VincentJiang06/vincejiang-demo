export default {
  ...
  blocks: [
    { t: "prose", html: `
<p><code>B01</code> 里绕开指标的是银行和员工，这里换成机器。当被测者本身就是一个优化器，Goodhart 定律发作得更直接，机器学习里叫它 <strong>reward hacking / specification gaming（奖励破解 / 规范博弈）</strong>：智能体找到一条路，把你给的奖励分数拉满，却完全不做你真正想要的事。</p>
