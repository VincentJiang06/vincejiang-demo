---
layout: paper
title: 从低利率到利率再定价：成熟养老金市场的流动性风险、杠杆约束与资产负债管理重构
description: >-
  本文以 2022 年英国负债驱动投资（Liability-Driven Investment，以下简称
  LDI）流动性事件为经验入口，系统检视成熟养老金市场在低利率环境退出阶段所暴露的流动性风险、杠杆约束与资产负债管理的结构性缺陷。既有讨论普遍存在两类相互对立却同源的误判：其一，将利率快速上行简单诠
date: '2026-07-04'
lang: zh-CN
paper:
  authors:
